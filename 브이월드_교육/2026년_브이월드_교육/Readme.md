...
- (서비스 활용) 공간정보와 브이월드의 개념을 알고 서비스 기능을 활용할 수 있다.
- (공간정보 분석) 브이월드 데이터를 활용하여 공간정보를 시각화하고 분석할 수 있다.
- (오픈API 개발) 브이월드 API를 활용하여 2D/3D 지도와 주제도를 표출할 수 있다.
...
## 교육자료 다운로드(~6.22 업로드 예정)

📥 1. 브이월드 서비스 활용 교육자료</br>
📥 2. 브이월드 공간정보 분석 교육자료</br>
📥 3. 브이월드 오픈API 개발 교육자료</br>
</br>
